...
const WhyChooseUs: React.FC = () => {
  return (
    <section className="relative flex flex-col lg:flex-row items-center justify-center min-h-screen overflow-hidden bg-[#000719] text-white px-6 sm:px-10 lg:px-20 py-16 sm:py-24 lg:py-32 font-[Poppins]">
      ...
      <div className="relative z-[3] w-full lg:w-1/2 flex justify-center items-center order-first lg:order-last mb-12 lg:mb-0">
        <div className="relative">
          ...
          />
          {/* Static Glow Effect */}
          <div className="absolute inset-0 rounded-full blur-3xl bg-cyan-400/20" />
        </div>
      </div>

      {/* === Content - Second on Mobile, Left on Desktop === */}
      <div className="relative z-[3] w-full lg:w-1/2 max-w-2xl text-center lg:text-left space-y-6 sm:space-y-8 order-last lg:order-first">
